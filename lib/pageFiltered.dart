...
class PageFilter extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PageFilter();
}

class _PageFilter extends State<PageFilter> {
  bool? value = false;
  List<Icon> icons = [
  ...
  var LinkStream = FirebaseFirestore.instance
      ...
      .where("categories", arrayContains: DataManager.instance.categoryFilter)
      .snapshots();
  ...
  String catToShow() {
    String x = DataManager.instance.categoryFilter;
    if (x.length > 13) {
      x = x.substring(0, 13) + "...";
      return x;
    } else {
